...
17      |shl r1, r2          |11 r1[4],r2[4]                        |左位移        |将r2左移r1位
18      |shr r1, r2          |12 r1[4],r2[4]                        |右位移
19      |rol r1, r2          |13 r1[4],r2[4]                        |左旋
20      |ror r1, r2          |14 r1[4],r2[4]                        |右旋
21      |ldi(b/w/d/q) imm, r |15 8/16/32/64[4],r[4] imm[8/16/32/64] |加载立即数
22      |ldm r1, r2          |16 r1[4],r2[4]                        |从内存加载      |将r1所指的内存处的数据加载到r2中（r1前可不加*号）
23      |stm r1, r2          |17 r1[4],r2[4]                        |保存到内存      |将r1的内容保存到r2所指的内存中（r2前可不加*号）
24*     |ei                  |18                                    |使能中断
25*     |di                  |19                                    |关闭中断
26*     |ep                  |1a                                    |使能分页
27*     |dp                  |1b                                    |关闭分页
